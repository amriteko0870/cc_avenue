...
'''
accessCode = 'AVFO04KE94CN66OFNC'
workingKey = 'DE16C051DB632BEA851E1F882B8BCDD5'
@app.route('/')
def webprint():
    return render_template('payments.html')
@app.route('/ccavResponseHandler', methods=['POST'])
...
def ccavRequestHandler():
    ...
    <iframe width="482" height="2000" scrolling="No" frameborder="0" id="paymentFrame" src="http://test.ccavenue.com/transaction/transaction.do?command=initiateTransaction&merchant_id=$mid&encRequest=$encReq&access_code=$xscode">
    </iframe>
    </center>
    <script type="text/javascript">
    $(document).ready(function(){
        $('iframe#paymentFrame').on('load', function() {
